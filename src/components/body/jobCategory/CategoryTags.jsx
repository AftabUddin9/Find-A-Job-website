    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mx-24 max-w-[1920px]">
            {jobCategories.map((category, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-white border-[1px] rounded-lg cursor-pointer">
                    <div className="flex items-center">
                        <div className="flex items-center justify-center w-10 h-10 border-2 bg-[#FEFBEF] border-[#FEFBEF] rounded-full mr-4">
